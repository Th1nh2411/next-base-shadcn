    ...
    <div className='bg-white-300 pb-24 pt-44'>
      <div className='container mx-auto grid w-full grid-flow-row grid-cols-3 grid-rows-6 gap-4 px-8 sm:grid-flow-col sm:grid-cols-12 sm:grid-rows-1 xl:px-16'>
        ...
        <div className='row-span-2 flex flex-col sm:col-span-2 sm:col-start-7 sm:col-end-9'>
          <p className='mb-4 text-lg font-medium text-black'>Product</p>
          <ul className='text-black '>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Download </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Pricing </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Locations </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Server </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Countries </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Blog </li>
          </ul>
        </div>
        <div className='row-span-2 flex flex-col sm:col-span-2 sm:col-start-9 sm:col-end-11'>
          <p className='mb-4 text-lg font-medium text-black'>Engage</p>
          <ul className='text-black'>
            ...
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Tutorials </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>About Us </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>
              Privacy Policy{' '}
            </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>
        ...
        <div className='row-span-2 flex flex-col sm:col-span-2 sm:col-start-11 sm:col-end-13'>
          <p className='mb-4 text-lg font-medium text-black'>Earn Money</p>
          <ul className='text-black'>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>Affiliate </li>
            <li className='my-2 cursor-pointer transition-all hover:text-orange-500'>
              Become Partner{' '}
            </li>
          </ul>
