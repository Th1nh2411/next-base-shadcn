...
const Pricing = () => {
  ...
  return (
    <div className='w-full bg-gradient-to-b from-white-300 to-white py-14' id='pricing'>
      <div className='container mx-auto flex w-full flex-col justify-center px-8 text-center xl:px-16'>
        <div className='flex w-full flex-col'>
          ...
          <div className='grid grid-flow-row grid-cols-1 gap-4 px-6 py-8 sm:grid-flow-col sm:grid-cols-3 sm:px-0 lg:gap-12 lg:px-6 lg:py-12'>
            <ScrollAnimationWrapper className='flex justify-center'>
              <motion.div
                variants={scrollAnimation}
                className='flex flex-col items-center justify-center rounded-xl border-2 border-gray px-6 py-4 lg:px-12 xl:px-20'
                whileHover={{
                  scale: 1.1,
                  transition: {
                    duration: 0.2,
              ...
              >
                ...
                <p className='my-2 text-lg font-medium capitalize text-black sm:my-7'>Free Plan</p>
                <ul className='flex flex-grow list-inside flex-col items-start justify-start pl-6 text-left text-black xl:pl-0'>
                ...
                <div className='mb-8 mt-12 flex w-full flex-none flex-col justify-center'>
                  <p className='mb-4 text-center text-2xl text-black '>Free</p>
            ...
            <ScrollAnimationWrapper className='flex justify-center'>
              ...
              >
                ...
                <p className='my-2 text-lg font-medium capitalize text-black sm:my-7'>
                  Standard Plan{' '}
                </p>
                <ul className='flex flex-grow list-inside flex-col items-start justify-start pl-6 text-left text-black xl:pl-0'>
                  <li className='check custom-list relative my-2'>Unlimited Bandwitch</li>
                ...
                <div className='mb-8 mt-12 flex w-full flex-none flex-col justify-center'>
                  <p className='mb-4 text-center text-2xl text-black '>
        ...
        <div className='my-16 flex w-full flex-col'>
          <ScrollAnimationWrapper>
            <motion.h3
              variants={scrollAnimation}
              className='mx-auto w-9/12 text-2xl font-medium leading-relaxed text-black sm:w-6/12 sm:text-3xl lg:w-4/12 lg:text-4xl'
            >
        ...
        <div className='my-16 flex w-full flex-col' id='preview'>
          <ScrollAnimationWrapper>
            <motion.h3
              variants={scrollAnimation}
              className='sm: mx-auto w-9/12 text-2xl font-medium leading-normal text-black sm:text-3xl lg:w-4/12 lg:text-4xl'
            >
          ...
          <ScrollAnimationWrapper className='relative mt-16 w-full'>
            <motion.div variants={scrollAnimation} custom={{ duration: 3 }}>
              <div className='absolute z-10 flex w-full flex-col items-center justify-between rounded-xl bg-white px-6 py-8 sm:flex-row sm:px-12 sm:py-14 lg:px-16'>
              ...
              <div
                className='roudned-lg absolute left-0 right-0 top-0 mx-auto mt-8 h-60 w-11/12 bg-black opacity-5 sm:h-56'
